...
void TamaServerObjectConfig::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("get_z_index"),                 &TamaServerObjectConfig::get_z_index);
    ClassDB::bind_method(D_METHOD("set_z_index","v"),             &TamaServerObjectConfig::set_z_index);
