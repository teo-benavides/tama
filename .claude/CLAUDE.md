...
you can find the grammar for TamaScript in tamascript_grammar.bnf , the reference for BulletML at @BulletML_Reference.htm . the "BulletML scripts" folder contains example BulletML scripts, and in the root directory you can find the tamascripts folder, which among other TamaScript files, contains bowap.tam and enemies.tam, which have BulletML close equivalents in "BulletML scripts" as bowap.xml and enemies.xml respectively.
